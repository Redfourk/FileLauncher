...
def main():
    ...
    # Path to your icon based on your folder structure
    icon_path = base_dir / "assets" / "FileLauncher16.ico"

    def graphical_button_operation():
        # Ensure path points to your gui file
    ...
    def command_line_button_operation():
        ...
        # Use 'cmd /c start' with a TITLE to avoid the path-as-title bug
        ...
        try:
            subprocess.Popen(
                ...
                shell=True,
                cwd=str(base_dir),
                # 0x00000010 (CREATE_NEW_CONSOLE) is mandatory for pythonw apps
                creationflags=0x00000010,
                # We redirect streams to DEVNULL so pythonw doesn't hang
